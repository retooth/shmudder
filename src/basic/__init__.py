#    This package is part of Shmudder.
#
...
""" @author: Fabian Vallon 
    ...
    This package includes all classes for game objects, that you need
    to create a basic MUD. There is still a lot of fancy stuff in other 
    modules.
 """